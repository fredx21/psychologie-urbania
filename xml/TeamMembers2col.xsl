...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" >
    ...
    <div class="mainContainer">
      <div class="content">
        ...
        <div class="sectiontext copyright">
          Copyright 2016 © Clinique de Psychologie Urbania. Tous droits réservés.
        </div>
      </div>
    </div>
    <!-- Google Code for team Conversion Page -->
      ...
      <noscript>
          <div style="display:inline;">
              <img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1040801619/?value=0&amp;label=9T4sCKnrhgUQ076l8AM&amp;guid=ON&amp;script=0"/>
          </div>
      </noscript>
  </body>
</html>
  ...
  <xsl:template name="WriteMember">
    ...
    <xsl:text disable-output-escaping="yes"><![CDATA[<a href="]]></xsl:text><xsl:value-of select="PageName"/><xsl:text disable-output-escaping="yes"><![CDATA[">]]></xsl:text><xsl:text disable-output-escaping="yes"><![CDATA[<img src="]]></xsl:text><xsl:value-of select="Photo"/><xsl:text disable-output-escaping="yes"><![CDATA["/>]]></xsl:text><xsl:text disable-output-escaping="yes"><![CDATA[</a>]]></xsl:text>
    <div class="member-description">
    <h3><span><xsl:text disable-output-escaping="yes"><![CDATA[<a href="]]></xsl:text><xsl:value-of select="PageName"/><xsl:text disable-output-escaping="yes"><![CDATA[">]]></xsl:text><xsl:value-of select="Name"/><xsl:text disable-output-escaping="yes"><![CDATA[</a>]]></xsl:text></span></h3>
    <h1><span><xsl:value-of select="$academic"/></span></h1>
    <p><span><xsl:value-of select="$summary"/></span></p>
    </div>
    <xsl:text disable-output-escaping="yes"><![CDATA[<div class="detailLink memberLink"><a href="]]></xsl:text><xsl:value-of select="PageName"/><xsl:text disable-output-escaping="yes"><![CDATA[">détails</a></div>]]></xsl:text>
  </xsl:template>
